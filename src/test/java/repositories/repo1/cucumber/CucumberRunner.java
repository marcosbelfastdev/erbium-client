...
@SelectClasspathResource("fakeStore/features") // Points to src/test/resources/features
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "tests.cucumber.fakeStore.steps") // Specifies step definitions package
